        ...
        <form onSubmit={handleSearch} className="w-full max-w-2xl px-4">
            <div className="relative group">
                <input
                    ...
                    className="w-full bg-slate-800/50 border border-slate-700 text-slate-100 pl-12 pr-4 py-4 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all placeholder:text-slate-400 shadow-2xl backdrop-blur-xl group-hover:border-slate-600"
                />
